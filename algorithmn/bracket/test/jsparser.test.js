const { parse, regHelp, parseStr, getClosure, getClosureState, parseExpression } = require('../jsparser')
...
describe('ExpressionParse', () => {
  ...
  //     ['StetementList', [['StatementListItem'], ['StatementList', 'StatementListItem']]]
  //   ])
  //   const initialState = {
  //     StetementList: {
  //       EOF: {
